...
bottom_floor = gr.cube('bottom_floor')
...
do
        wood_plane = gr.mesh( 'wood_plane', 'plane.obj' )
...
do
        small_panel = gr.mesh( 'small_panel', 'plane.obj' )
...
-- pillar section
pillar = gr.mesh('pillar', 'cube.obj')
...
first_floor:rotate('Y', -45)

-- The lights
l1 = gr.light({200,200,400}, {0.8, 0.8, 0.8}, {1, 0, 0})
l2 = gr.light({0, 5, -20}, {0.4, 0.4, 0.8}, {1, 0, 0})

gr.render(scene, 'first_floor.png', 512, 512, 
